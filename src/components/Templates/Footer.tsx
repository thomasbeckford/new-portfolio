      ...
      <div className="container mx-auto ">
        <div className=" py-10 text-center md:text-left">
          <div className="grid-1 grid md:grid-cols-3 md:justify-items-center">
            <div className="w-full">
              ...
              <div className="">
                <div className="flex justify-center md:justify-start mb-4">
                  <a
                    href="https://twitter.com/tebeckford"
                    className="mr-6  "
                    target="_blank"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.instagram.com/thom.beck/"
                    className="mr-6  "
                    target="_blank"
                  >
                    <svg
                  ...
                  <a
                    href="https://github.com/thomasbeckford"
                    target="_blank"
                    className=" "
                  >
                    <svg
            ...
            <div className="w-36 h-36 relative mx-auto my-5 md:my-0">
              <Image
